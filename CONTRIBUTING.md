...
Please keep in mind that while all efforts to help the Cyberseals in developing software are recognised and greatly appreciated, this project does not currently require any outside contribution.
...
`[HBDEM-7] Create awesome function`
...
An example of a correctly branch names is `feature/hbdem-6`
